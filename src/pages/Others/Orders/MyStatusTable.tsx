...
const MyStatusTable = ({ data }) => {
    ...
    return (
        <div>
            <div className=' flex items-center justify-end px-4 h-[4rem]'>  <Button className='flex items-center justify-center'
